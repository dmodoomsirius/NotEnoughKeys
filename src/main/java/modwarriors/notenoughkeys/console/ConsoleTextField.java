	...
	public void drawTextBox() {
		if (getVisible()) {
			if (getEnableBackgroundDrawing()) {
				drawRect(xPos - 1, yPos - 1, xPos + width + 1, yPos + height + 1, 0x440077);
				drawRect(xPos, yPos, xPos + width, yPos + height, 0xFFFFFF);
			}
			...
			int var7 = enableBackgroundDrawing ? xPos + 24 : xPos;
			...
			if (var4.length() > 0) {
				...
				var9 = fontRenderer.drawStringWithShadow(var10, var7,
						var8, var1);
			}
